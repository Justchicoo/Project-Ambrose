...
enum WorldDatabaseStatements : uint32
{
    ...
    WORLD_SEL_PLAYER_LEVEL_STATS,
    WORLD_SEL_MAGIC_SCHOOL_TEMPLATES,
    WORLD_SEL_MAGIC_SCHOOL_BADGES,
    WORLD_SEL_MAGIC_XP_CONFIG,
    WORLD_SEL_MAGIC_XP_ENCOUNTER_FACTORS,
    WORLD_SEL_MOB_RANK_LEVELS,
    WORLD_SEL_STAT_EFFECT_CONFIG,
    WORLD_SEL_STAT_CRIT_BLOCK_BANDS,
    WORLD_SEL_STAT_PIP_CONVERSION_BANDS,
