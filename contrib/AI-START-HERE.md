...
Open the pull request against `main` from your own fork, say in the description which item you took, and ask the maintainer for the `contrib` label. A finding that turns out to be wrong is still worth sending.
