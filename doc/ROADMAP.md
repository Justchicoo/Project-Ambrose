...
| 3 | [Create, list and delete a wizard](roadmap/phase-03-create-list-and-delete-a-wizard.md) | 24 | A player creates a wizard (school, look, name). It appears on character select with the right appearance, persists across restarts, and can be deleted. |
