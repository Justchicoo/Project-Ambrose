...
-- Creates the updates_include table of folders the updater reads for the login database, with $ standing for the Project Ambrose folder.
...
INSERT IGNORE INTO `updates_include` (`path`, `state`) VALUES
    ('$/data/sql/updates/db_login', 'RELEASED'),
    ('$/data/sql/custom/db_login', 'CUSTOM');
