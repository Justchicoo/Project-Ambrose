...
The full plan lives in [doc/ROADMAP.md](doc/ROADMAP.md): 17 phases and 355 milestones, each ending in something visible in the real client. Project Ambrose is MIT licensed ([LICENSE](LICENSE)), and [THIRD-PARTY-NOTICES.md](THIRD-PARTY-NOTICES.md) lists every library it uses and what each licence asks. The look every screen follows is in [doc/DESIGN.md](doc/DESIGN.md), and the stack every screen is built with in [doc/UI-STACK.md](doc/UI-STACK.md). The tool suite is in [doc/TOOLS.md](doc/TOOLS.md) and the client strategy in [doc/CLIENT.md](doc/CLIENT.md).
