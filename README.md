...
The full plan lives in [doc/ROADMAP.md](doc/ROADMAP.md): 17 phases and 353 milestones, each ending in something visible in the real client. The look every screen follows is in [doc/DESIGN.md](doc/DESIGN.md). The tool suite is in [doc/TOOLS.md](doc/TOOLS.md) and the client strategy in [doc/CLIENT.md](doc/CLIENT.md).
